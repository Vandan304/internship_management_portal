...
const { getConversations, getMessages, sendMessage, uploadFile, getChatUsers, markMessagesAsRead, deleteMessages } = require('../controllers/chatController');
...
router.route('/messages').delete(deleteMessages);
